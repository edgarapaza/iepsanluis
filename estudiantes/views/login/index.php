...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/iepsanluis/estudiantes/public/css/login.css">

</head>
<body>
<!-- partial:index.partial.html -->
<form action="http://localhost/iepsanluis/estudiantes/login/user" method="POST">
...
<!-- <div class="iep">
  <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus, nulla rerum quaerat, eos, esse unde incidunt veritatis odio iusto consectetur quos ratione illum vitae fugit accusantium magnam vero magni ex?</h1>
</div> -->

<!-- partial -->
<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TweenMax.min.js'></script>
<script  src="http://localhost/iepsanluis/estudiantes/public/js/login/login.js"></script>
